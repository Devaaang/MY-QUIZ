class Question {
    ...
    display(){
    this.title.html("My Favorite Game !!!!!");
    this.title.position(350,0);

    this.question.html("What's my favorite Game?");
    this.question.position(100,30);
    this.option1.html("1: fortnite");
    this.option1.position(150,60);
    this.option2.html("2: Cricket");
    this.option2.position(150,100);
    this.option3.html("3: Minecraft");
    this.option3.position(150,140);
    this.option4.html("4: Tennis");
